// source: https://github.com/rancher/rke2-product-docs/edit/main/versions/latest/modules/en/pages/advanced.adoc
...
----
+
. Install the {nvoperator} using the following YAML manifest.
+
[source,yaml]
----

...
For more information about OAuth 2.0 in {owui} and a complete description of each environment variable, refer to https://docs.openwebui.com/features/auth/sso/[{owui} SSO] documentation. 

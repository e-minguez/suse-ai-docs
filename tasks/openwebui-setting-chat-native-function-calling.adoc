...
.Enabling native function calling fig_owui_enabling_nfc
...
[#owui-nfc-for-more-info]
== For more information

You may find the following information sources useful: 

* https://github.com/open-webui/mcpo[{mcpo} homepage on GitHub]
* https://docs.openwebui.com/features/extensibility/plugin/tools/openapi-servers/open-webui[{owui} Integration documentation]
* https://docs.openwebui.com/features/extensibility/mcp[{owui} support for {mcp}]

...
* https://docs.openwebui.com/features/plugin/tools/openapi-servers/open-webui[{owui} Integration documentation]
* https://docs.openwebui.com/features/mcp[{owui} support for {mcp}]

...
* _(Optional)_*: to install a specific {ranchera} version, set the `rancherImageTag` value, for example: `--set rancherImageTag=v2.5.8`
...
* link:https://documentation.suse.com/cloudnative/rancher-manager/latest/en/installation-and-upgrade/references/helm-chart-options.html[{ranchera} {helm} chart options]
...
* link:https://documentation.suse.com/cloudnative/rancher-manager/latest/en/installation-and-upgrade/troubleshooting/troubleshooting.html[Troubleshooting {ranchera} {kube} Installations]

...
For more information on RKE node roles, see the link:https://documentation.suse.com/cloudnative/rancher-manager/v2.13/en/cluster-deployment/production-checklist/production-checklist.html#_cluster_architecture[best practices.]

// source: https://github.com/rancher/rancher-product-docs/edit/main/versions/v2.13/modules/en/pages/cluster-deployment/register-existing-clusters.adoc
// base URL: https://documentation.suse.com/cloudnative/rancher-manager/v2.13/en/
...
For more information on RKE node roles, see the link:https://documentation.suse.com/cloudnative/rancher-manager/v2.13/en/production-checklist/production-checklist.html#_cluster_architecture[best practices.]
...
You should define *only* the minimum fields that Rancher requires when importing an EKS cluster with Terraform. This is important as Rancher will overwrite what was in the cluster configuration with any configuration that the user has provided.
endif::[]
...
* link:https://documentation.suse.com/cloudnative/rancher-manager/v2.13/en/rancher-admin/users/authn-and-authz/manage-role-based-access-control-rbac/cluster-and-project-roles.html[Manage cluster access] through role-based access control
* Enable link:https://documentation.suse.com/cloudnative/rancher-manager/v2.13/en/observability/monitoring-and-dashboards/monitoring-and-dashboards.html[monitoring, alerts and notifiers]
* Enable link:https://documentation.suse.com/cloudnative/rancher-manager/v2.13/en/observability/logging/logging.html[logging]

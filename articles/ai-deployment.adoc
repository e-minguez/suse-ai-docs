...
= Deploying and Installing {productname}:docinfo:
:doctype: article
:experimental:
...
// https://github.com/rancher/rancher-product-docs/edit/main/versions/v2.13/modules/en/pages/installation-and-upgrade/install-rancher.adoc
...
:override-title: Installation
:override-abstract: {empty}
include::../tasks/ai-lifecycle-manager-installing.adoc[leveloffset=+3]

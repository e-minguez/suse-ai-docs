...
// https://github.com/rancher/rke2-product-docs/edit/main/versions/latest/modules/en/pages/install/airgap.adoc
include::../tasks/RKE2-installation-airgapped.adoc[leveloffset=+2]
// https://github.com/rancher/rke2-product-docs/edit/main/versions/latest/modules/en/pages/install/quickstart.adoc
...
// https://github.com/rancher/rancher-product-docs/edit/main/versions/v2.13/modules/en/pages/installation-and-upgrade/other-installation-methods/air-gapped/air-gapped.adoc
include::../tasks/Rancher-installation-airgapped.adoc[leveloffset=+2]
// https://documentation.suse.com/cloudnative/rancher-manager/latest/en/installation-and-upgrade/other-installation-methods/air-gapped/infrastructure-private-registry.html
...
// https://github.com/rancher/rancher-product-docs/edit/main/versions/v2.13/modules/en/pages/installation-and-upgrade/other-installation-methods/air-gapped/publish-images.adoc
...
// https://github.com/rancher/rancher-product-docs/edit/main/versions/v2.13/modules/en/pages/installation-and-upgrade/other-installation-methods/air-gapped/install-kubernetes.adoc
:override-title: Install {kube}
include::../tasks/Rancher-installation-airgapped-kubernetes.adoc[leveloffset=+3]
// https://github.com/rancher/rancher-product-docs/edit/main/versions/v2.13/modules/en/pages/installation-and-upgrade/other-installation-methods/air-gapped/install-rancher-ha.adoc
:override-title: Install {ranchermanager}
include::../tasks/Rancher-installation-airgapped-rancher.adoc[leveloffset=+3]
// https://github.com/rancher/rke2-product-docs/edit/main/versions/latest/modules/en/pages/add-ons/gpu_operators.adoc
include::../tasks/NVIDIA-Operator-installation.adoc[leveloffset=+2]
// https://github.com/rancher/rancher-product-docs/edit/main/versions/v2.13/modules/en/pages/cluster-deployment/register-existing-clusters.adoc
